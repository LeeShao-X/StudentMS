...
<%--    <s:textfield name="stu.sex" label="性别" size="16"/>--%>
    ...
    <input type="radio" name="stu.sex" value="女"/>女<br>
<%--    <s:radio list="genders" label="性别" name="stu.sex" value="defaultGenderValue"/>--%>
<%--    <s:textfield name="stu.birthday" label="生日" size="16"/>--%>
<%--    <s:textfield name="stu.university" label="大学" size="16"/>--%>
<%--    <s:textfield name="stu.department" label="学院" size="16"/>--%>
<%--    <s:textfield name="stu.major" label="专业" size="16"/>--%>
<%--    <s:textfield name="stu.grade" label="年级" size="16"/>--%>
    ...
    专业：<input type="text" name="stu.major" value=""><br>
    年级：<input type="text" name="stu.grade" value=""><br>
    <s:submit value="增加学生信息"/>
</s:form>
