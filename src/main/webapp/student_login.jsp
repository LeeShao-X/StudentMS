...
<s:form action="StudentLogin" method="post">
    <s:textfield name="sno" label="学号" size="16" style="width: 350px;font-size: 18px;border: 0;border-bottom: 2px solid#fff;padding: 5px 10px;background:#ffffff00;color: #fff;"/>
